    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="职级" align="center" key="level" prop="levelId" v-if="columns[5].visible" :formatter="getLevelName" />
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="职级">
              <el-select v-model="form.levelId" clearable>
                <el-option v-for="(item,index) in levelList" :key="index" :label="item.levelName" :value="item.levelId"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getLevelName(row){
      const p = this.levelList.filter(item => item.levelId == row.levelId)
      if(p.length>0){
        return p[0].levelName
      } else {
        return ""
      }
    }
